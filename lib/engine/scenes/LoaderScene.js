...
class LoaderScene extends FollowScene {
    ...
    _constructor(canvas) {
        ...
        // ローディングシーンにそんなに高いフレームレート必要ないでしょう。ローディングにもCPU能力回してやらないといけないと思うんで…
        // なので基底としてはこの値。
        this.framerate = 12;
...
class LoadingRemain extends Executant {
    ...
    _constructor() {
        ...
        // 画面右下を起点とする。
        this.behaviors.set( new PositionAnchor(null, new Point(1,1), new Point(-100,-100)) );
